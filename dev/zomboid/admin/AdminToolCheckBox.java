...
public class AdminToolCheckBox extends UIElement
{
    ...
    public AdminToolCheckBox(final UIElement target, final float x, final float y, final String text, final String name) {
        this.toggled = false;
    ...
    public AdminToolCheckBox(final UIEventHandler var1, final int var2, final int var3, final String var4, final String var5) {
        this.toggled = false;
        this.mouseOver = false;
        this.MessageTarget2 = null;
        this.x = var2;
    ...
    public Boolean onMouseUp(final double var1, final double var3) {
        ...
        if (this.MessageTarget2 != null) {
            this.MessageTarget2.Selected(this.name, (int)(this.toggled ? 1 : 0), 0);
        }
